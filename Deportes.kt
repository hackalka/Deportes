...
class AnimeflvnetProvider : MainAPI() {
    companion object {
        fun getType(t: String): TvType {
            ...
            else if (t.contains("Deportes")) TvType.Deportes
            else TvType.Deportes
        }
    ...
    override var mainUrl = "https://www.fctv33.buzz/es"
    override var name = "Deportes"
    ...
    override suspend fun getMainPage(page: Int, request : MainPageRequest): HomePageResponse {
        val urls = listOf(
            Pair("$mainUrl/browse?type[]=movie&order=updated", "Deportes"),
        )
        ...
        doc.select("script").map { script ->
            if (script.data().contains("var episodes = [")) {
                ...
                data.split("],").forEach {
                    ...
                    //val epthumb = "https://www.fctv33.buzz/es"
